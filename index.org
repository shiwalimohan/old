...
My current work focuses on designing cognitive robots that can communicate with human collaborators using natural language and can expand their skill set (and language comprehension) by engaging the human collaborator in instructional learning. The work looks at several interesting research challenges including embodied language comprehension, interactive collaboration, and active, agent-driven learning. The agents are designed within the framework of  [[http://sitemaker.umich.edu/soar/home][Soar Cognitive Architecture]] - an architecture for design of generally intelligent agents.
...
* Research
*** Active Learning with Instruction
...
Collaborators: John E. Laird

*** Reinforcement Learning
Collaborator: John E. Laird, Mandar Joshi
...
Soar},
booktitle = {(to appear) In AAAI Fall Symposium on Integrated Cognition},
year = {2013},
