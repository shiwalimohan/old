...
-----
#+begin_center
#+html:  <a href="#" onclick="$('#hiddenText').show(); return false;">Contact</a> | <a href="http://www.shiwali.me/resume/cv.pdf">CV</a> | Statements | <a href="http://scholar.google.com/citations?user%3DEYWzxPIAAAAJ&hl%3Den">Google Scholar</a> | <a href="https://www.linkedin.com/in/shiwalimohan">LinkedIn</a> 
#+html: <div style="display: none;" id="hiddenText">shiwali dot mohan at gmail dot com; shiwali at umich dot edu</div> 
#+end_center
-----
...
title = {Learning Goal-Oriented Hierarchical Tasks from Situated Interactive Instruction (corrected)},
