...
mixed-initiative task-oriented dialog.

\emph{Situated language for embodied agents}\\ 
Developing the Indexcial model of situated comprehension that
translates amodal linguistic symbols to modal perceptual, spatial, and
...
\emph{Reinforcement learning in Soar cognitive architecture}\\
 ...
 architecture that allows for simultaneously learning multiple markov decision processes. 
...
\item Experience with cognitive architectures - Soar and ACT-R.
\item Experience in programming with Java, C++, Perl, Python and JavaScript.
\end{itemize}
...
\begin{multicols}{2}
\begin{itemize}
\item \textbf{John E. Laird, Professor of Economics} \\
