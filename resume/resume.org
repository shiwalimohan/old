...
Advisor: Professor [[http://ai.eecs.umich.edu/people/laird/][John E. Laird]] \\
...
Designed, implemented, and analyzed an interaction model for agents
 ...
 derived generally applicable procedural knowledge from a history of
 (available in episodic/semantic memory of the agent) using situated
 explanation.

 Graduate Student Research Assistant to Professor [[%20http://ai.eecs.umich.edu/people/laird/][John E. Laird]] \hfill
